...
export const MOCK_CEMS: CEM[] = [
    {
        dealerId: '1719', // Keeler Honda
        name: 'Chris Peck',
        email: 'chris.peck@mykaarma.com',
        photoUrl: '/cem-pictures/Chris_Peck.png',
    ...
    },
    {
        ...
        photoUrl: '/cem-pictures/Devon_Supper.png',
    ...
    },
    {
        ...
        photoUrl: '/cem-pictures/Shon_Lucas.png',
    ...
    },
    {
        ...
        photoUrl: '/cem-pictures/David_Smith.png',
    ...
    },
    {
        ...
        photoUrl: '/cem-pictures/Mark_DeGeorge.png',
    ...
    },
    {
        ...
        photoUrl: '/cem-pictures/Denise_Farrar.png',
    ...
    },
    {
        ...
        photoUrl: '/cem-pictures/Blaine_Schultz.png',
...
export const getCEMForDealer = (dealerId: string): CEM | undefined => {
    ...
    return {
        ...
        photoUrl: '/cem-pictures/Doug_MacGlashan.png',
        calendarLink: 'https://calendly.com/doug-macglashan',
        isOutOfOffice: false,
    };
};

export const getDealerByName = (text: string): Dealer | undefined => {
